...
st.markdown("<h1 style='text-align: center;'>Mining KBM (FO)</h1>", unsafe_allow_html=True)
st.markdown("<p style='text-align: center;'>Exportable Final Ore (Feeding)</p>", unsafe_allow_html=True)
